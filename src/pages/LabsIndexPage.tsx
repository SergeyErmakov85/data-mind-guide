...
const labs: Lab[] = [
  ...
  { id: 'riemann', title: 'Интеграл Римана', description: 'Как измерить накопленный стресс или тревогу за день? Изучите интегральное исчисление через психологические примеры: сумма Римана, предел, связь с вероятностью. Задачи для самостоятельной работы.', icon: Sigma, path: '/labs/riemann', difficulty: 'beginner', concepts: ['Сумма Римана', 'Плотность вероятности', 'Накопленный эффект'], status: 'available', indexLabel: 'INTEGRAL' },
];
